...
public class PrimeirosPassos {
    ...
    @Test
    @DisplayName("Prmeiros passos com o google.com")
    @Disabled
    public void teste01() throws InterruptedException {

        // drive.navigate().to("https://www.google.com.br");
        driver.get("https://www.google.com.br");

        // WebElement campoPesquisa = drive.findElement(By.id("ti6dpd"));
        // campoPesquisa.sendKeys("ifpe Jaboatão");
        // drive.findElement(By.id("ti6dpd")).sendKeys("ifpe Jaboatao");

        driver.findElement(By.name("q")).sendKeys("ifpe Jaboatão" + Keys.ENTER);
        driver.findElement(By.cssSelector(
                "body > div.plsC5e.RqyYHe > div.acUsEb.Q6KTif.KEY6ib > form > div:nth-child(1) > div > div.FPdoLc.T14B5e.iThwld > center > input.gNO89b"))
                .click();
    ...
    public void teste02() throws InterruptedException {
        ...
        Thread.sleep(1000);
        driver.findElement(
                By.cssSelector("#menu-principal > li > ul > li.page_item.page-item-1340.page_item_has_children > a"))
                .click();
